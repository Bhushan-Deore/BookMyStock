...
function ProductsPage() {
    return (
        <>
            ...
            <RightSection imageURL="/media/images/console.png" productName="Console" productDescription="The central dashboard for your BookMyStock account. Gain insights into your trades and investments with in-depth reports and visualisations." learnMore=""/>
            ...
            <h4 className="text-center">Want to know more about our technology stack? Check out the <a href="" style={{ textDecoration: "none" }}>BookMyStock.tech</a> blog.</h4>
            <Universe />
        </>
    );
}
